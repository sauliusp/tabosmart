...
export async function createPreviewServer(root) {
  const allowed = new Map([
    ...
    ["/favicons.mjs", "text/javascript"],
    ["/workspace-view.mjs", "text/javascript"],
    ["/storage-budget.mjs", "text/javascript"],
    ["/welcome.html", "text/html"],
    ["/welcome.css", "text/css"],
    ["/icons/feedback-qr.svg", "image/svg+xml"],
